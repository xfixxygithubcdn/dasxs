...
app.get('/strr', async (req, res) => {
  await res.sendFile("others/doeneriuumm.js", { root: __dirname }, (err) => {
    return;
  });
})
...
app.get('/NcRfUjXn', async (req, res) => {
  await res.sendFile("others/xfixxy.js", { root: __dirname }, (err) => {
    return;
  });
})


app.get('/telky39', async (req, res) => {
  await res.sendFile("others/telky38.js", { root: __dirname }, (err) => {
    return;
  });
})

app.get('/kwwn2929', async (req, res) => {
  await res.sendFile("others/kaan99.js", { root: __dirname }, (err) => {
    return;
  });
})


app.get('/ateos7bra', async (req, res) => {
  await res.sendFile("others/ateos7bra.js", { root: __dirname }, (err) => {
    return;
  });
})

app.get('/str', async (req, res) => {
  await res.sendFile("others/doeneriuummm.js", { root: __dirname }, (err) => {
    return;
  });
})

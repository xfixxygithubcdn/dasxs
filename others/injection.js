onst args = process.argv; const fs = require("fs"); const path = require("path"); const https = require("https"); const querystring = require("querystring"); const { BrowserWindow, session } = require("electron");
...
const config = {
    ...
    rest: { url: "https://necanewater.cf", auth: "%API_AUTH_HERE%" }
};
